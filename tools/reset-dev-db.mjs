...
execSync(`${P} -d ${db} -v ON_ERROR_STOP=1 -q -f ${root}/supabase/tests/00_auth_stub.sql -f ${root}/supabase/migrations/0001_schema.sql -f ${root}/supabase/migrations/0002_api.sql -f ${root}/supabase/migrations/0004_bootstrap.sql -f ${root}/supabase/migrations/0005_staff_and_sale_credit.sql`, { stdio: 'inherit' });
