...
$P -d proaid -v ON_ERROR_STOP=1 -q -f tests/00_auth_stub.sql -f migrations/0001_schema.sql -f migrations/0002_api.sql -f migrations/0004_bootstrap.sql -f migrations/0005_staff_and_sale_credit.sql
